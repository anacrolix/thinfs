...
ThinfsErrno thinfs_pread(Thinfs *, ThinfsFd fd, void *buf, size_t count, off_t);
ThinfsErrno thinfs_pwrite(Thinfs *, ThinfsFd fd, void const *buf, size_t count, off_t);
...
ThinfsErrno thinfs_opendir(Thinfs *, char const *path);
